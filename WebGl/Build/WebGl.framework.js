...
var ASM_CONSTS = {
  5216256: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5216317: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5216381: function() {return Module.webglContextAttributes.powerPreference;},  
 5216439: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5216494: function($0) {performance.now = function() { return $0; };},  
 5216542: function($0) {performance.now = function() { return $0; };},  
 5216590: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _EthereumInitRpcClientCallback(callBackAccountChange, callBackChainChange) {   
          ethereum.on("accountsChanged",
                  function (accounts) {
                      let account = "";
                      if(accounts[0] !== undefined){
